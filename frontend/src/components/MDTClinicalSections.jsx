...
export default function MDTClinicalSections({ result, formData, generatePDF }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
            ...
            <div className="flex">
                {/* SIDEBAR NAVIGATION */}
                <aside className="w-64 bg-slate-900/50 border-r border-slate-800 min-h-screen flex flex-col">
                    <div className="px-4 py-4 border-b border-slate-800">
                        <h1 className="text-xs font-semibold text-slate-100 uppercase tracking-wider leading-tight">
                            MDT Clinical Review
                        </h1>
                    ...
                    <div className="px-3 py-4 border-t border-slate-800">
                        <button
                            onClick={generatePDF}
                            className="w-full px-4 py-3 text-sm font-medium text-slate-100 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors"
                        >
                            Export Report
                        </button>
                    </div>
